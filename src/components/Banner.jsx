...
const Banner = () => {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="relative bg-[url('/images/1.webp')] bg-cover bg-center bg-no-repeat min-h-[calc(100vh-200px)] flex items-center">
            ...
            <div className="z-50 p-6 md:p-10 rounded-xl text-white max-w-xl mx-auto lg:ml-[10%] space-y-4">
              ...
              <p className="font-medium leading-relaxed">
                Join us at the Green Living Expo 2025 to explore sustainable
                tools, attend expert-led workshops, and connect with
                eco-conscious communities—all designed to help you grow a
                greener future.
              </p>
              <Link to={"/alltips"}>
        ...
        <SwiperSlide>
          <div className="relative bg-[url('/images/3.jpg')] bg-cover bg-center bg-no-repeat min-h-[calc(100vh-200px)] flex items-center">
            <div className="absolute bg-black/25 inset-0"></div>
            <div className="z-50 p-6 md:p-10 rounded-xl text-white max-w-xl mx-auto lg:ml-[10%] space-y-4">
              <h2 className="text-3xl md:text-5xl font-bold">
        ...
        <SwiperSlide>
          <div className="relative bg-[url('/images/2.jpg')] bg-cover bg-center bg-no-repeat min-h-[calc(100vh-200px)] flex items-center">
            <div className="absolute bg-black/25 i inset-0"></div>
            <div className="z-50 p-6 md:p-10 rounded-xl text-white max-w-xl mx-auto lg:ml-[10%] space-y-4">
