            ...
            <div className="relative bg-[url('/images/3.jpg')] bg-cover bg-center bg-no-repeat  min-h-[calc(100vh-200px)]">
             ...
             space-y-4 w-full md:w-1/4 lg:w-1/3 text-white "
              >
                ...
                <p>
                  Discover how easy it is to grow fresh food and plants right
                  from your balcony, rooftop, or backyard—no experience
                  required.
                </p>
                <button className="btn ">Learn More</button>
              </div>
             ...
             space-y-4 w-full md:w-1/4 lg:w-1/3 text-white "
              >
                ...
                <p>
                  ...
                  resources, and inspiration to make cities greener—one plant at
                  a time.
                </p>
                <button className="btn">Learn More</button>
              </div>
