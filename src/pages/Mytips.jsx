  ...
  return (
    <div className="container mx-auto px-4 py-12 mt-16">
      <div className="flex justify-between mb-6">
        <h2 className="text-2xl font-bold">My Shared Garden Tips</h2>
      ...
      {all.length === 0 ? (
        <div className="text-center text-gray-600 py-10">You haven’t shared any tips yet.</div>
      ) : viewMode === "table" ? (
<div>
      <div className="overflow-x-auto rounded-md border border-secondary container mx-auto lg:min-h-[calc(100vh-500px)] mt-28 mb-12">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between mt-3">
                  <Link to={`/tipdetails/${item._id}`} className="btn btn-sm btn-info">
                    <FaEye />
                  </Link>
                  <Link to={`/updatemytip/${item._id}`} className="btn btn-sm btn-warning">
                    <FaPen />
                  </Link>
                  <button onClick={() => handleDelete(item._id)} className="btn btn-sm btn-error">
                    <MdDelete />
                  </button>
                </div>
              </div>
