            ...
            {data.map((tip) => (
              ...
              >
                <div className="card-body space-y-2">
                  ...
                  <p className="text-sm text-gray-500">{tip.description.slice(0, 40)}...</p>
                  <div className="flex flex-wrap justify-between text-sm text-neutral">
                    <span>Difficulty: <strong>{tip.difficulty}</strong></span>
                    <span>Category: <strong>{tip.category}</strong></span>
                    <span>Type: <strong>{tip.type}</strong></span>
