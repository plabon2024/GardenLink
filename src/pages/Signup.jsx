...
const Singnup = () => {
  ...
  return (
    <div>
      <section className="my-28 grid text-center text-info  items-center p-8 bg-warning w-fit mx-auto rounded-md">
        <div className="w-full max-w-md mx-auto text-left">
          <h2 className="text-3xl font-bold mb-2 text-primary">Sign up</h2>
